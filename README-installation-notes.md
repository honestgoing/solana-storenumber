...
### Git Repository
Clone the 'solana-storenumber' repository into your development machine:
```bash
$ cd /path/to/your/work/folder/
$ git clone https://github.com/honestgoing/solana-storenumber.git
$ cd solana-storenumber
```
